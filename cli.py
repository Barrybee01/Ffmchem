...
def main():
    ...
    parser.add_argument("--scrape-top", type=float, help=f"Remove fraction from beginning (e.g., 0.2 removes first 20%)")
    parser.add_argument("--scrape-bottom", type=float, help=f"Remove fraction from end (e.g., 0.2 removes last 20%)")
